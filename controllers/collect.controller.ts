...
export class CollectController {
    ...
    wrapMethod(method:(req:Request, res:Response )=>string | Promise<string>){
...
collectBook = async (req:Request,res:Response) => { 
    try {
        ...
        console.log("collectBook",iAmBatMan)
        const book_id = await this.collectService.convertBookNameToId(req.body.book_id);
